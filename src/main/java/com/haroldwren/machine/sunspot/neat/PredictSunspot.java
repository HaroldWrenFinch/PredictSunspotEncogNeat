package com.haroldwren.machine.sunspot.neat;
...
public class PredictSunspot {
    ...
    public final static double MAX_ERROR = 0.005;
    ...
    public NEATNetwork train(MLDataSet training) {
        NEATPopulation pop = new NEATPopulation(WINDOW_SIZE,1,1000);
        ...
        do {
            train.iteration();
            System.out.println("Iteration: " + epoch + ", Error: " + train.getError() + ", Species: " + pop.getSpecies().size());
            epoch++;
    ...
    public void predict(NEATNetwork network) {
    ...
    public void run() {
        ...
        NEATNetwork network = train(training);
        predict(network);
